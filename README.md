...
**A deterministic, constitutional workload regulator.**
...
rgov represents a departure from "kind" infrastructure. rgov is not a scheduler and does not optimize execution; it enforces declared resource contracts. It is built on three non-negotiable pillars:
...
- **Deterministic CPU Governance**: Windowed regulation $(State, Observation, Budget) \to (Enforcement)$.
